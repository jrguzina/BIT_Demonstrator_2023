  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          double widthScale = maxWidth / 1160;
          double heightScale = maxHeight / 1160;
          ...
          return Column(children:[
            ...
            children: [
              const Text(
                'Konfiguration eines Smart Homes und Visualiserung der zugehörigen Statistiken',
                style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold),),
              InfoWidget(infoText: 'Auf dieser Seite könne sie sich ihr eigenes Wunsch-Smart-Home mit verschiedenen Produkten konfigurieren und anzeigen lassen.'
                  'Am rechten Seitenrand wird dynamisch der CO2-Footprint des konfigurierten Smart-Homes berechnet und visualisiert. Hierfür werden die drei dargestellten '
                  'Phasen des Lebenszyklus betrachtet.',
